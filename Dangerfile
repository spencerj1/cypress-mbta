...
if github.pr_labels.include?("status: Approved")
  auto_label.remove("status: Done")
  auto_label.remove("status: Wait For Review")  
end
...
if github.pr_labels.empty?
  ...
  auto_label.set(pr_number, "status: WIP", "ffb347") 
